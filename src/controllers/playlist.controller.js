...
const addVideoToPlaylist = asyncHandler(async (req, res) => {
    ...
    if(!isValidObjectId(playlistId)){
        throw new ApiError(400, "This palylist id is not valid")
    }
    ...
    // if video is alresy exists in playlist
    ...
    if(!addedToPlaylist){
        throw new ApiError(500, "someting went wrong while added video to playlist!")
    }
...
const removeVideoFromPlaylist = asyncHandler(async (req, res) => {
    ...
    if(!isValidObjectId(playlistId)){
        throw new ApiError(400, "This playlistId id is not valid")
    }
