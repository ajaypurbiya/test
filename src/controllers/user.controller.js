...
const generateAccessAndRefereshTokens = async(userId) =>{
  try {
    ...
    throw new ApiError(500, "Something went wrong while genrating refreash and access token");
  }
}
...
const registerUser = asyncHandler( async (req, res) => {
  ...
  // check if your alresy exists: username, email
  ...
  if (!username?.trim()) {
    throw new ApiError(400, "userame is required")
  }
  ...
  if (!avatar) {
    throw new ApiError(500, "Avatar file is required 2")
  }
...
const updateUserAvatar = asyncHandler(async(req, res) =>{
  ...
  .status(200)
  .json(
    new ApiResponse(200, user, "avatar image fatched successfully")
  )
})
